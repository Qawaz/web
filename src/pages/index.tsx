                ...
                <div className="container">
                    <div className="site-header-inner">
                        <div className="brand header-brand">
                            <h1 className="m-0">
                                <a href="#">
                                    <StaticImage src={"./images/logo.svg"} alt={"Logo"} className="header-logo-image"/>
                                </a>
                            </h1>
                        </div>
                    </div>
                        ...
                        <div className="hero-inner">
                            ...
                            <div className="mockup-container">
                                <div className="mockup-bg">
                                    <img
                                        src="dist/images/iphone-hero-bg.svg"
                                        alt="iPhone illustration"
                                    />
                                </div>
                                <img
                                    className="device-mockup"
                                    src="dist/images/mockup-front.png"
                                    alt="iPhone Hero"
                                />
                            </div>
                        </div>
                            ...
                            <div className="container">
                                <div className="feature-extended">
                                    <div className="feature-extended-image">
                                        <div className="mockup-bg">
                                            <img
                                                src="dist/images/iphone-feature-bg-01.svg"
                                                alt="iPhone Feature 01 illustration"
                                            />
                                        </div>
                                        <img
                                            className="device-mockup is-revealing"
                                            src="dist/images/mockup-left-nav.png"
                                ...
                                <div className="feature-extended">
                                    <div className="feature-extended-image">
                                        <div className="mockup-bg">
                                            <img
                                                src="dist/images/iphone-feature-bg-02.svg"
                                                alt="iPhone Feature 02 illustration"
                                            />
                                        </div>
                                        <img
                                            className="device-mockup is-revealing"
                                            src="dist/images/mockup-filter.png"
                                ...
                                <div className="feature-extended">
                                    <div className="feature-extended-image">
                                        <div className="mockup-bg">
                                            <img
                                                src="dist/images/iphone-feature-bg-03.svg"
                                                alt="iPhone Feature 03 illustration"
                                            />
                                        </div>
                                        <img
                                            className="device-mockup is-revealing"
                                            src="dist/images/mockup-tag.png"
                                ...
                                <div className="feature-extended">
                                    <div className="feature-extended-image">
                                        <div className="mockup-bg">
                                            <img
                                                src="dist/images/iphone-feature-bg-04.svg"
                                                alt="iPhone Feature 04 illustration"
                                            />
                                        </div>
                                        <img
                                            className="device-mockup is-revealing"
                                            src="dist/images/mockup-search.png"
                        ...
                        <div className="site-footer-inner">
                            ...
                            <ul className="footer-links list-reset">
                                <li>
                                    <a
                                        target="_blank"
                                        href="http://timeline-app.tk/privacy-policy"
                                    >Privacy Policy</a
                                    >
                                </li>
                                <li>
                                    <a
                                        target="_blank"
                                        href="http://timeline-app.tk/terms-of-services"
                                    >Terms of Services</a
                                    >
                                </li>
                                <li>
